...
export default function LearnPage({ params }: { params: Promise<{ mode: string }> }) {
  ...
  return (
    <div className="container" style={{ maxWidth: "800px", padding: "1rem", minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      {/* Feedback Footer Modal (Sticky Continue button on mobile & scrollable content) */}
      {feedback && (
        <div className="animate-fade-in" style={{
          ...
          <div style={{
            ...
            <div className="container flex md-flex-col md-items-center md-text-center justify-between items-center gap-4" style={{ maxWidth: "1000px" }}>
              ...
              <div style={{ display: "flex", gap: "0.6rem", flexWrap: "wrap", justifyContent: "center", alignItems: "center" }}>
                ...
                {/* Map preview */}
                <div style={{ width: "150px", height: "95px", borderRadius: "var(--radius-md)", overflow: "hidden", border: "1.5px solid rgba(255,255,255,0.15)", boxShadow: "0 6px 18px rgba(0,0,0,0.5)" }}>
          ...
          {/* Sticky CTA Action Bar for Continue Button */}
          <div style={{
            ...
            <div className="container" style={{ maxWidth: "1000px", width: "100%", display: "flex", justifyContent: "center" }}>
